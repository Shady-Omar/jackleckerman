          ...
          <div id="edit-event-pop" class="items-center justify-center relative">
            <div class=" flex fixed z-10 top-0 w-full h-full bg-black bg-opacity-60" style="overflow-y: overlay;">
              <div class="extraOutline p-4 bg-white w-max bg-whtie m-auto rounded-lg">
                  ...
                  <div class="relative">
                      <input autocomplete="off" required id="edit-coord-first-name" name="name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="First Name" value="${docx.data().firstName}"/>
                      <label for="edit-coord-first-name" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">First Name</label>
                    </div>
                    <div id="edit-error-one"></div>

                    <div class="relative">
                      <input autocomplete="off" required id="edit-coord-second-name" name="name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Last Name" value="${docx.data().lastName}"/>
                      <label for="edit-coord-second-name" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Last Name</label>
                    </div>
    ...
    if (attendContainer) {
      ...
      if(status) {
        if (docx.data().status === 0) {
          ...
          <button id="reject-req-${docx.id}" type="button" class="focus:outline-none text-white bg-red hover:bg-black focus:ring-4 focus:ring-red font-medium rounded-lg text-sm px-5 py-2.5 mr-4  my-2">Reject</button>
          <button id="delete-req-${docx.id}" type="button" class="focus:outline-none text-white bg-red hover:bg-black focus:ring-4 focus:ring-red font-medium rounded-lg text-sm px-5 py-2.5 my-2">Delete</button>
          ...
          <button id="modify-req-${docx.id}" type="button" class="focus:outline-none text-white bg-blue hover:bg-darkblue focus:ring-4 focus:ring-blue font-medium rounded-lg text-sm px-5 py-2.5 mr-4 my-2">Modifiy</button>
          <button id="delete-req-${docx.id}" type="button" class="focus:outline-none text-white bg-red hover:bg-black focus:ring-4 focus:ring-red font-medium rounded-lg text-sm px-5 py-2.5 my-2">Delete</button>
        ...
        let deleteRequest = document.querySelector(`#delete-req-${docx.id}`);
        ...
        if(deleteRequest) {
          deleteRequest.addEventListener('click' , async () => {
            if (confirm("Are you sure you want to delete this invitation request?")) {
